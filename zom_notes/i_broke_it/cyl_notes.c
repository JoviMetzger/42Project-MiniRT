...
// 	{
// 		// obj->hit_pos = normalize(mult_vecdub(cyl->vector, obj->t));
...
// 		{
// 			puts("top");
// 			cyl->normal = normalize(cyl->vector);
...
// 		{
// 			// puts("bottom");
// 			cyl->normal = normalize(mult_vecdub(cyl->vector, -1)); // yes? for opposite 
...
// 			puts("hello");
// 			// obj->hit_pos = mult_vecdub(ray->vector, obj->t);
// 			// cyl->normal = normalize(minus(obj->hit_pos, cyl->center));
