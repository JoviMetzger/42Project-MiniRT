...
/*   Updated: 2024/03/15 18:53:21 by smclacke      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
int	sort_pl(char **elem_str, t_data *data)
{
	...
	if (!is_rgb(elem_str[3], 0, 0, 0))
		return (0);
	if (!convert_rgb(data, elem_str[3], 4))
		return (0);
	return (1);
}
...
int	sort_sp(char **elem_str, t_data *data)
{
	...
	if (!is_rgb(elem_str[3], 0, 0, 0))
		return (0);
	if (!convert_rgb(data, elem_str[3], 5))
		return (0);
	return (1);
}
...
int	sort_cy(char **elem_str, t_data *data)
{
	...
	if (!is_rgb(elem_str[5], 0, 0, 0))
		return (0);
	if (!convert_rgb(data, elem_str[5], 6))
		return (0);
	return (1);
}
