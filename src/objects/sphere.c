 ...
 */
static bool intersect_sphere(t_ray *ray, t_objs *sphere, t_obj_data *obj_data)
{
    double radius;
    t_vec3	oc;
...
bool	calc_sphere(t_ray *ray, t_objs *sphere, t_obj_data *obj_data)
{
	if (intersect_sphere(ray, sphere, obj_data))
	{
