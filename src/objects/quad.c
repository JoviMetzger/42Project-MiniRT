...
/*   Updated: 2024/04/15 21:06:00 by smclacke      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
bool	quadratic(t_obj_data *obj_data)
{
	...
	obj_data->root1 = (-obj_data->b + obj_data->d) / (2.0 * obj_data->a);
	obj_data->root2 = (-obj_data->b - obj_data->d) / (2.0 * obj_data->a);
	if (obj_data->root1 > 0 && obj_data->root1 < obj_data->root2)
