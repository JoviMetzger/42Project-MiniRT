...
/*                                                   +#+                      */
/*   Created: 2024/04/25 16:05:27 by smclacke      #+#    #+#                 */
/*   Updated: 2024/04/25 16:06:45 by smclacke      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */

#include "../../header/miniRT.h"

t_colour sphere_colour(t_data *data, t_obj_data *obj_data, t_ray ray, t_objs *sphere)
{
    t_colour result;
