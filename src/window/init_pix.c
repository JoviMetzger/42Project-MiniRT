...
/*   Updated: 2024/06/15 19:03:51 by smclacke      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void	do_calcs(t_data *data)
{
	...
	// {
	// 	int 	ob = 0;
	// 	while (ob < data->objs_i)
	// 	{
	// 		if (data->pix[i]->hit_b == true)
	// 		{
	// 			uint32_t	colour;
	// 			// data->vars.base = get_base_colour(data->objs[ob], &data->vars);
	...
	// 			colour = ft_convert_rgb(data->vars.result.r, data->vars.result.g, data->vars.result.b);
