...
/*   Updated: 2024/03/25 14:07:31 by smclacke      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void	print_parser(t_data *data)
{
	...
	while (index < data->objects->index)
	{
		
		printf("obj type = %i\n", data->objects[index].type);
		printf("coords = %f,%f,%f\n", data->objects[index].center.x, data->objects[index].center.y, data->objects[index].center.z);
		index++;
	}
	// printf("\tsp\n");
